...
def get_dataset(dataset_name, target_folder="./", datasets=DATASETS_CONFIG):
    ...
    if dataset_name == "PaviaC":
        ...
        # Load the image - 变量名是 'data'
        img = open_file(folder + "Houston.mat")["data"]

        rgb_bands = (50, 30, 20)  # 可以根据视觉效果调整

        # Load the ground truth - 变量名是 'groundT'
        gt = open_file(folder + "Houston_gt.mat")["groundT"]
