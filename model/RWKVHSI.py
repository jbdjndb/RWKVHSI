...
class RWKVBlock(nn.Module):
    def __init__(self, dim):
        ...
        self.channelmix = ChannelMix(dim)
...
class RWKVHSI(nn.Module):
    def __init__(self, in_channels, num_classes, embed_dim=32, reduced_bands=30, depth=1):
        super().__init__()
        self.depth = depth
...
def test_model():
    ...
    # 创建模型
    model = RWKVHSI(in_channels=C, num_classes=num_classes, embed_dim=32, reduced_bands=30)
